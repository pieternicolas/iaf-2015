...
$stock_sql = "SELECT stock FROM feb14stock WHERE tier='$tier'";
...
$stockUpdate = "UPDATE feb14stock SET stock=$newStock WHERE tier='$tier'";
mysqli_query($conn,$stockUpdate);

$insert = "INSERT INTO feb14order (name, nric, email, contact, tier, quantity, price, payment, submissiontime)
